...
{
	define( 'WP_SEO_REDIRECTION_VERSION', '4.9'); 
}
...
//      }
      ...
      elseif (!preg_match( '/^(http|https):\\/\\/[a-z0-9_]+([\\-\\.]{1}[a-z_0-9]+)*\\.[_a-z]{2,5}'.'((:[0-9]{1,5})?\\/.*)?$/i', $_POST['redirect_to'])) {
                $data['inputerror'][] = 'redirect_to';
...
seoredirection.msg='<?php echo $total_404_errors.'<div class="wrap">'.__('Upgrade to','wsr').' <a target="_blank" href="http://www.clogica.com/product/seo-redirection-premium-wordpress-plugin">'.__("pro version","wsr").'</a>'.__(" to manage 404 errors and empower your site seo","wsr") ?></div>';

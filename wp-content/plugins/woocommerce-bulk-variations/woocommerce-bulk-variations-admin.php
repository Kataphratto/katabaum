	...
	public function add_meta_box() {
		...
		if ( $post && $post->post_type == 'product' ) {
			...
			if ( empty( $product ) || ! $product->is_type( 'variable' ) ) {
				...
				add_meta_box( 'woocommerce-bulk-variations', __( 'Bulk Variation Input', 'wc_bulk_variations' ), array(
					$this,
					'meta_box'
        ...
        <div id="product_views" class="panel">
            <div class="woocommerce_product_views">
				...
				<?php else : ?>
                    ...
                    <p>
                        <label class=""><?php _e( 'Bulk Variation Form:', 'wc_bulk_variations' ); ?></label>
                        <select name="_bv_type">
                            <option value="0"><?php _e( 'Disabled', 'wc_bulk_variations' ); ?></option>
                            <option <?php echo $cur_product_view == 'matrix' ? 'selected="selected"' : '' ?>
                                    value="matrix"><?php _e( 'Enabled', 'wc_bulk_variations' ); ?></option>
                        </select>
                    </p>

                    <p>
                        <label class=""><?php _e( 'Singular Variation Form:', 'wc_bulk_variations' ); ?></label>

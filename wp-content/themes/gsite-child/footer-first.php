...
?>
	...
	<div class="prefooter">
		<div class="container">
			<h3>I prodotti su questo sito sono solo una selezione di articoli scelti da baumgartner per voi!</h3>
			<h4>Se vuoi vedere il catalogo completo <a href="http://www.officeprofi.ch/index.cfm?hid=BVTMAG" target="_blank">clicca qui.</a></h4>
		</div>
	</div>

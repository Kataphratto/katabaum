...
global $projects_loop, $post, $complex_projectrows, $complex_opt, $wp_query;
...
<div class="main-container">
	<div class="entry-header">
		<div class="container">
			<h1 class="entry-title" style="margin-bottom: 0px"><?php $category->term_id;?></h1>
	...
	<div class="container">
		...
		<div class="page-content">
			...
			if( isset($complex_opt['portfolio_per_page']) ) {
				$projects_per_page = $complex_opt['portfolio_per_page'];
			}
			...
			<?php if ( $projects_query->have_posts() ) : ?>
				...
				<div class="filter-options btn-group">
					<button data-group="all" class="btn active btn-warning"><?php esc_html_e('All', 'complex');?></button>
					<?php 
					$datagroups = array();

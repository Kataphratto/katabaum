...
global $product, $woocommerce_loop, $complex_opt;

$posts_per_page = ($complex_opt['related_amount']) ? $complex_opt['related_amount'] : 8; 
...
<div class="widget related_products_widget related products">
	...
	<h3 class="widget-title"><span>
		<?php if(!empty($complex_opt['related_title'])){ ?>
			<?php echo esc_html($complex_opt['related_title']); ?>
		<?php }else{ ?>
			<?php esc_html_e( 'Prodotti correlati', 'complex' ); ?>
		<?php } ?>
	</span></h3>

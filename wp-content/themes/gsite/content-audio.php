	...
	<?php if ( ! post_password_required() && ! is_attachment() ) : ?>
		<?php 
			if ( is_single() ) { ?>
				...
				<?php } ?>
				<div class="player"><?php echo do_shortcode(get_post_meta( get_the_ID(), 'complex_featured_post_value', true )); ?></div>
			<?php }
		?>
		<?php if ( !is_single() ) { ?>
			<?php if ( has_post_thumbnail() ) { ?>
			<div class="post-thumbnail">
				<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('complex-post-thumb'); ?></a>
				<span class="post-date">
					<span class="day"><?php echo get_the_date( esc_html__('d', 'complex'), get_the_ID() ); ?></span>
					<span class="month"><?php echo get_the_date( esc_html__('M', 'complex'), get_the_ID() ); ?></span>
				</span>

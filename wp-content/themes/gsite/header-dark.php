	...
	<div class="top-bar">
		<div class="container">
			...
			<div class="header-login-form">
				<span class="lock-icon"><i class="ion-locked"></i><?php echo esc_html__('My Account', 'complex'); ?><i class="fa fa-angle-down"></i></span>
				<div class="acc-form">
				...
				<div class="col-md-3 categories-nav">
					<div class=" categories-menu showmore-menu">
						...
						<div class="menu-container">
							...
							<div data-items="<?php echo intval($complex_opt['categories_menu_items']); ?>" class="showmore-cats hide"><i class="fa fa-plus"></i><span><?php echo esc_html__('More Categories', 'complex') ?></span></div>
							<?php } ?>
						</div>
					</div>
				</div>
				<?php } ?>
				<div class="col-md-<?php echo esc_attr($main_nav_col); ?> main-nav">
